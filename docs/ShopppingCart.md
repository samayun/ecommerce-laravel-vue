Shopping Cart In Laravel Vuejs
======================

Install : `composer require melihovv/laravel-shopping-cart`

Publish Vendor : `php artisan vendor:publish --provider="Melihovv\ShoppingCart\ServiceProvider"`
