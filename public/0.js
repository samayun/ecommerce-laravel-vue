...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])("categoriesStoreIndex", ['editSubData', 'editSubMeta', 'errors'])), {}, {
    imageVisible: {
      get: function get() {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])("categoriesStoreIndex", ['editSubCategory'])), Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapMutations"])("categoriesStoreIndex", ['TOGGLE_MODAL'])),
  created: function created() {
    var _this = this;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])("categoriesStoreIndex", ['editMeta', 'editData', 'errors', 'multiSelected'])), Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])("categoriesStoreIndex", ['getAllSubCategory', 'filterString'])),
  methods: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("categoriesStoreIndex", ['getSubCategories', 'editCategory', 'deleteSubCategory', 'multiDelete', 'handleSelectionChange', 'changeSubPaginatedPage', 'changeSubPaginatedPerPage'])), Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])("categoriesStoreIndex", ['TOGGLE_MODAL', 'GET_SUB_EDIT_DATA'])), {}, {
    ...
    [
      _c(
        "Modal",
        {
          attrs: {
            role: "form",
            title: _vm.$t("subcategories.edit"),
            "mask-closable": false,
            closable: false,
        ...
        [
          ...
          _c("Input", {
            ...
            attrs: { placeholder: "Edit Sub category name" },
            model: {
                  ...
                  _vm._v(
                    _vm._s(
                      _vm.editSubData.busy
                        ? _vm.$t("subcategories.editing")
                        : _vm.$t("subcategories.edit")
                    )
                  )
                ]
              )
