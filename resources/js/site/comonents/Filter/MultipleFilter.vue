                        ...
                        <div class="filter-items filter-items-count">
                            ...
                            >
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" multiple class="custom-control-input" id="cat-8"  :value="category.id">
                                    <label class="custom-control-label" for="cat-8"> {{ category.name }} </label>
                ...
                <div class="collapse show" id="widget-2">
                    <div class="widget-body">
                        <div class="filter-items">
                            ...
                            >
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="size-6" :value="size.id">
                                    <label class="custom-control-label" for="size-6"> {{ size.name }} </label>
                ...
                <div class="collapse show" id="widget-4">
                    <div class="widget-body">
                        <div class="filter-items">
                            ...
                            >
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="brand-7" v-model="selected.brands">
                                    <label class="custom-control-label" for="brand-7"> {{ brand.name }} </label>
