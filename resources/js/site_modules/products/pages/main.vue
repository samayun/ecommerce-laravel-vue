                ...
                <div class="col-md-6">
                    <div class="product-details">
                        ...
                        <div class="details-filter-row details-row-size"
                                     ...
                                     :key="a.id">
                            <label for="size"> {{ a.type.name }} :</label>
                            <div class="select-custom">
                                <select name="size" id="size" class="form-control">
                                    <option value="#" selected="selected">Select a {{ a.type.name }} </option>
                                    <option
                                     :value="a.slug">{{ a.name }}</option>
                                </select>
...
export default {
 computed:{
     ...mapState("productsStoreIndex",["product"])
 },
 methods:{
