...
Vue.component(
    "admin-app",
    require("./admin_layout/components/AdminApp.vue").default
);
Vue.component(
    "Loading",
    require("./admin_layout/components/Loading.vue").default
);
Vue.component(
    "filter-data",
    require("./admin_layout/components/FilterData.vue").default
);
Vue.component(
    "Pagination",
    require("./admin_layout/components/Pagination.vue").default
);
