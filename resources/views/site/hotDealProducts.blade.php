            ...
            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                ...
                <div class="product">
                    <figure class="product-media">
                        ...
                        <div class="product-action">
                            <a href="/product/2" class="btn-product btn-cart" title="Add to cart"><span>add to cart</span></a>
                        </div><!-- End .product-action -->
                    </figure><!-- End .product-media -->

                    <div class="product-body">
                        <div class="product-cat">
                            <a href="/product/2">Furniture</a>
                        </div><!-- End .product-cat -->
                ...
                <div class="product">
                    <figure class="product-media">
                        ...
                        <span class="product-label label-sale">Sale</span>
                        <a href="product.html">
                            <img src="/storage//products/product-2.jpg" alt="Product image" class="product-image">
                        </a>
                    ...
                    <div class="product-body">
                        <div class="product-cat">
                            <a href="/product/2">Electronics</a>
                        </div><!-- End .product-cat -->
                        ...
                        <div class="product-nav product-nav-dots">
                            <a href="/product/2" class="active" style="background: #69b4ff;"><span class="sr-only">Color name</span></a>
                            <a href="/product/2" style="background: #ff887f;"><span class="sr-only">Color name</span></a>
                            <a href="/product/2" style="background: #333333;"><span class="sr-only">Color name</span></a>
                        </div><!-- End .product-nav -->
                    </div><!-- End .product-body -->
                </div><!-- End .product -->
                ...
                <div class="product">
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-nav product-nav-dots">
                            <a href="/product/2" class="active" style="background: #b58555;"><span class="sr-only">Color name</span></a>
                            <a href="/product/2" style="background: #93a6b0;"><span class="sr-only">Color name</span></a>
                        </div><!-- End .product-nav -->
                    </div><!-- End .product-body -->
                </div><!-- End .product -->
                ...
                <div class="product">
                    <figure class="product-media">
                        <span class="product-label label-sale">Sale</span>
                        <a href="product.html">
                            <img src="/storage//products/product-4.jpg" alt="Product image" class="product-image">
                        </a>
                ...
                <div class="product">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="/storage//products/product-6.jpg" alt="Product image" class="product-image">
                        </a>
